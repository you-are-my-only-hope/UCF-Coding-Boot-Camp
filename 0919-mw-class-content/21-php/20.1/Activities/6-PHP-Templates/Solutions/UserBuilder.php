...
class UserBuilder {
  ...
  public function buildUser ($get, $post) {
    ...
    // Note that null is false in PHP
    if (!$source)
      return null;
...
/* Uncomment these lines to demonstrate static fields.
 *
 *  You'll also need to redeclare these properties as public static.
 *
echo UserBuilder::$firstName . "\n";
echo UserBuilder::$lastName . "\n";
echo UserBuilder::$email . "\n";
 *
 */
